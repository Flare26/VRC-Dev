Shader "Hidden/.poiyomi/• Poiyomi Toon •/New Material 4-New Material 4"
{
    Properties
    {
...
#define PROPM_START_MATCAPHUESHIFT 1
#define PROP_MATCAPHUESHIFTENABLED 1
...
#define PROP_EMISSIONSTRENGTH 1.29
