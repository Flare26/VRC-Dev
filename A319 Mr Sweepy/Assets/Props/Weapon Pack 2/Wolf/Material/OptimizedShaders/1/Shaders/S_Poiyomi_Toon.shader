Shader "Hidden/.poiyomi/• Poiyomi Toon •/1-1"
{
    Properties
    {
...
#define PROP_GLITTERBRIGHTNESS 5
...
#define PROP_OUTLINEUSEVERTEXCOLORS 2
#define PROP_OUTLINELIT 1
#define PROP_LINEWIDTH 3
#define PROP_OUTLINEEMISSION 7.1
...
#define PROP_OUTLINEHUEOFFSET 0.39
#define PROP_OUTLINEHUEOFFSETSPEED 3
