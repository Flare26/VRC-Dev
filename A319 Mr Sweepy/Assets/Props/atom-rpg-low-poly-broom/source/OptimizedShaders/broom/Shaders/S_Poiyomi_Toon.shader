Shader "Hidden/.poiyomi/• Poiyomi Toon •/broom-broom"
{
    Properties
    {
...
#define PROP_RIMWIDTH 0.729
#define PROP_RIMSHARPNESS 0
#define PROP_RIMSTRENGTH 1
#define PROP_RIMBRIGHTEN 3
...
#define PROP_RIMHUESHIFTSPEED 6.66
