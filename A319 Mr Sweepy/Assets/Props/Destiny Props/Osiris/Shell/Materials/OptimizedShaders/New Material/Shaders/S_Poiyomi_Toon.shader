...
#define PROP_BRDFGLOSSINESS 0.829
#define PROP_BRDFREFLECTANCE 1
#define PROP_BRDFANISOTROPY 0.1
...
#define PROP_SPECULARMAXBRIGHTNESS 2
#define PROP_SPECULARMETALLICMAPUV 0
#define PROP_SPECULARSMOOTHNESS 0.46
