    ...
    void ApplyMetallics(inout float4 finalColor, in float4 albedo)
    {
            ...
            finalColor.rgb += reflecty_lighty_boy_uwu_var_2 * reflection.rgb * fresnelRelflection(albedo) * float4(1,0.7193342,0.2652483,1) * tintMap.rgb * tintMap.a;
        #endif
    }
