...
#define PROP_LIGHTINGWRAPPEDWRAP 0.29
...
#define PROP_BRDFMETALLIC 0.122
#define PROP_BRDFGLOSSINESS 0.534
#define PROP_BRDFREFLECTANCE 0.42
#define PROP_BRDFANISOTROPY 0
#define PROP_BRDFREFLECTIONSENABLED 1
#define PROP_BRDFSPECULARENABLED 0
