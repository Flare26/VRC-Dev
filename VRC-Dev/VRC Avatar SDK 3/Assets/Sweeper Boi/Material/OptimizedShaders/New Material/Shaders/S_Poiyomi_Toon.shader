Shader "Hidden/.poiyomi/• Poiyomi Toon •/New Material-New Material"
{
    Properties
    {
        ...
        [HideInInspector] shader_master_label ("<color=#000000ff>Poiyomi Toon V7.1.60</color>", Float) = 0
...
#define PROP_SSSWEIGHT 1
#define PROP_SSSBIAS 0
...
#define PROP_GITDEMINEMISSIONMULTIPLIER 0
...
#define PROP_EMISSIVEBLINK_MAX 5
#define PROP_EMISSIVEBLINK_VELOCITY 2
...
#define PROP_EMISSIVESCROLL_WIDTH 0
#define PROP_EMISSIVESCROLL_VELOCITY -34
#define PROP_EMISSIVESCROLL_INTERVAL 2
